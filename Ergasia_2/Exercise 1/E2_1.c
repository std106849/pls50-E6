...
// programma gia neo sistima katagrafis kratimenon theseon
...
void show(bus_system bus[])  //* function for showing a list of the booked seats by the data of the passenger */
{
 printf("Kratimenes theseis kata seira onomatos, tilefono kai theseis einai oi eksis:\n");
 printf("\n");
        for (i=0; i<nseats; i++)
...
readfile(bus);
    ...
    printf("         5. Emfanisi Listas Kratimenon Theseon\n");
